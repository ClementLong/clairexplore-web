<template>
	<div class="flex ml-4 relative text-lightblack">
		<input :class="[
			...
			'outline-none appearance-none rounded-l-lg border-l-2 border-t-2 border-b-2 text-sm px-2 py-1 sm:w-auto md:w-10 lg:w-auto'
		]" placeholder="Rechercher..." type="text" id="search" name="search" v-model="query" @focusin="isFocus = true"
			@focusout="isFocus = false" @keypress.enter="search">
		<label role="button" for="search" @click="search" :class="[
